...
- [x] **Step 3: README** — add a bullet under the dashboard/frontend feature description: live 3D system scene (pool/spa water, pump/filter/heater/chlorinator, animated flow) driven by the `/state` poll.
